		  ...
		  <!-- Collect the nav links, forms, and other content for toggling -->
		   <div class="collapse navbar-collapse navbar-ex1-collapse">
		    	...
		    	<ul class="nav navbar-nav navbar-right">
		      		<li><a href="AcaoLogin.php?metodo=sair">Sair</a></li>
		   		</ul>
		  	</div><!-- /.navbar-collapse -->
		</nav>
		<div class="container">
			<ul class="nav nav-tabs">
  				<li ><a href="FormPF.php">Pessoa Física</a></li>
 				<li class="active"><a href="FormPJ.php">Pessoa Jurídica</a></li>
			</ul>
			<label> &nbsp; </label>
			<fieldset>
					...
					<form action="" method="POST" role="form">
						...
						<div class="row ">
							<div class="form-group col-sm-6">
									...
									<input class="form-control" name="razaoSocial" type="text" />
							</div>
							<div class="form-group col-sm-3">
									<label> Inscrição Municipal </label>
									<input class="form-control" name="inscricaoEstadual" type="text" />
							</div>
							<div class="form-group col-sm-3">
									<label> Inscrição Estadual </label>
									<input class="form-control" name="dataCriacao" type="text" />
							</div>
						</div>	
						<div class="row">
