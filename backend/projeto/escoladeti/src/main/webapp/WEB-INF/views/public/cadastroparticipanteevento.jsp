            ...
            <fieldset>
                <form action="" method="POST" name="participante" ng-submit="salvar()">
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <br>
                        <label>CPF</label>
                        <input class="form-control" type="text" ng-change="ValidarCPF(participante.cpf)"  onKeyPress="MascaraCPF(participante.cpf);" maxlength="14" placeholder="Número do CPF" ng-model="participante.cpf" required>
                        <label>RG</label>
                        ...
                        <label>Email</label>
                        <input class="form-control" type="text"  placeholder="Endereço de email" ng-model="participante.email" required>
                        ...
                        <input name="deficiente" value="N" type="radio" ng-model="participante.deficiente" >  <label>Não</label>
                    </div>
                    <div align="right">
