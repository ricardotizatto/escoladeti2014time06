...
function PessoaFisicaController($scope, $routeParams, pessoaFisicaService, paisService, estadoService, cidadeService) {
	$scope.select2='one';
...
controllers.controller('PessoaFisicaController', ['$scope', '$routeParams', 'pessoaFisicaService', 'paisService', 'estadoService', 'cidadeService', PessoaFisicaController ]);